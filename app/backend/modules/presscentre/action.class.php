...
class PresscentreAction extends fvAction
{

    function __construct ()
    {
        parent::__construct(fvSite::$Layoult, PressCentreManager::getInstance() );
    }
    ...
    protected function executeSave()
    {
        ...
        try {
            $ex = PressCentreManager::getInstance()->getByPk( $id , true);
            
            $ex->addField('oldFile', 'string', $ex->file);            
            $ex->addField('oldIcon', 'string', $ex->icon);            
