    ...
    <table class="text">
        <tr>
            <th style="text-align:center;">
                <u>
                    <a href="javascript:void(0);" onclick="window.doSort('name_ru','{if $sort.dir=='asc'}desc{else}asc{/if}'); return false;">Название{if $sort.field=='name_ru'}<img src="{$fvConfig->get('dir_web_root')}img/{$sort.dir}_arrow.gif" width="11" height="13">{/if}
                    </a>
                </u>
            </th>
