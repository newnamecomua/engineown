...
class Partner extends fvRoot
{
    ...
    */
    ...
    {
        $dir = fvSite::$fvConfig->get('path.upload.partner' . ($isWeb ? "_web" : ""));
        if(!$isWeb)
    ...
    */
    public function saveImage()
    {
        ...
        $dstImage = fvSite::$fvConfig->get('path.upload.partner') . $this->image;
    ...
    */
    ...
    {
        $dstImage = fvSite::$fvConfig->get('path.upload.partner') . $this->oldImage;
    ...
    */
    ...
    {
       return ( $this->image && file_exists( fvSite::$fvConfig->get('path.upload.partner') . $this->image ) );
    }

    public function getParams($type)
    {        
       $image  = fvSite::$fvConfig->get('path.upload.partner') . $this->image;
