...
class Project extends fvRoot
{
    ...
    {
        $dir = fvSite::$fvConfig->get('path.upload.project' . ($isWeb ? "_web" : ""));
        if(!$isWeb)
    ...
    public function saveImage()
    {
        ...
        $dstImage = fvSite::$fvConfig->get('path.upload.project') . $this->image;
    ...
    {
        $dstImage = fvSite::$fvConfig->get('path.upload.project') . $this->oldImage;         
